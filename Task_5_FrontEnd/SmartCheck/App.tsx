...
import AttendanceButton from './src/components/Button';
import StatusCard from './src/components/AttendanceDetails.js';
import CourseProfile from './src/components/Course';
...
const App = () => {
  ...
  const handleFaceCapture = async (imageData: any) => {
  ...
  const handleTabPress = (tabId: React.SetStateAction<string>) => {
    setActiveTab(tabId);
  };
    // Navigation handlers
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
       <Input
          ...
          style={styles.searchInput} error={undefined}        />
        <View style={styles.cardsContainer}>
          <View style={styles.cardRow}>
            <SquareCard
              ...
              style={[styles.squareCard, { width: cardWidth }]} subtitle={undefined}            />
            <SquareCard
              title="View History"
              icon="attendance"
        ...
        <CourseProfile
          ...
          status={currentCourse.status} style={undefined}        />
        ...
        <StatusCard
          ...
          location={attendanceStatus.location} style={undefined}/>
        ...
        <View style={styles.buttonContainer}>
          <AttendanceButton
            ...
            onPress={handleCheckIn}
            variant="primary"
            style={styles.actionButton} textStyle={undefined}/>
          <AttendanceButton
            title="Check Out"
